...
"""Real behavioral tests for middlewares/maintenance.py"""
import pytest
...
def _import():
    try:
        import importlib
        return importlib.import_module("tg_bot.middlewares.maintenance")
    except (ImportError, ModuleNotFoundError) as e:
        pytest.skip(f"Cannot import: {e}")


class TestMaintenanceMiddleware:
    """Tests for MaintenanceMiddleware middleware."""

    def test_instantiate(self):
        mod = _import()
        mw = mod.MaintenanceMiddleware(MagicMock())
