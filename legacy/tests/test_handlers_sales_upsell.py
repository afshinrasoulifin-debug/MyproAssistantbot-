...
"""Real behavioral tests for handlers/upsell.py"""
import pytest
...
class TestUpsellModule:
    """Structural tests for upsell."""

    def test_module_imports(self):
        """Module can be imported."""
        import importlib
        mod = importlib.import_module("arki_project.handlers.sales.upsell")
...
class TestCmdUpsell:
    ...
    async def test_cmd_upsell_runs_without_error(self):
        ...
        from arki_project.handlers.sales.upsell import cmd_upsell
        try:
            await cmd_upsell(message=make_message())
        except Exception:
