...
"""Real behavioral tests for middlewares/i18n_middleware.py"""
import pytest
...
def _import():
    try:
        import importlib
        return importlib.import_module("tg_bot.middlewares.i18n_middleware")
    except (ImportError, ModuleNotFoundError) as e:
        pytest.skip(f"Cannot import: {e}")


class TestI18nMiddleware:
    """Tests for I18nMiddleware middleware."""

    def test_instantiate(self):
        mod = _import()
        mw = mod.I18nMiddleware()
