...
"""ServiceConnector — Connect to external services."""
...
class ServiceConnector:
    ...
    def __init__(self, *, name: str = "service_connector") -> None:
        self.name = name
        self._registry: Dict[str, Any] = {}
        self._stats = {"ops": 0, "errors": 0}
        logger.info("ServiceConnector '%s' initialized", name)
    ...
    async def execute(self, operation: str, data: Any = None) -> Dict:
        ...
        try:
            ...
            logger.error("ServiceConnector execute error: %s", e)
