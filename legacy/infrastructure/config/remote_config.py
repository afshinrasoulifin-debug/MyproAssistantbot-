...
"""InfraRemoteConfig — Remote configuration management."""
...
class InfraRemoteConfig:
    ...
    def __init__(self, defaults: Optional[Dict] = None) -> None:
        ...
        logger.info("InfraRemoteConfig initialized (%d defaults)", len(self._store))
    ...
    def set(self, key: str, value: Any) -> None:
        ...
        for listener in self._listeners.get(key, []):
            try:
                ...
                logger.warning("InfraRemoteConfig listener error: %s", e)
