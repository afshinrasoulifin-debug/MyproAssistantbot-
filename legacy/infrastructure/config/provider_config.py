...
"""InfraProviderConfig — Per-provider configuration."""
...
class InfraProviderConfig:
    ...
    def __init__(self, defaults: Optional[Dict] = None) -> None:
        ...
        logger.info("InfraProviderConfig initialized (%d defaults)", len(self._store))
    ...
    def set(self, key: str, value: Any) -> None:
        ...
        for listener in self._listeners.get(key, []):
            try:
                ...
                logger.warning("InfraProviderConfig listener error: %s", e)
