...
"""ExperimentalFlags — Experimental feature flags."""
...
class ExperimentalFlags:
    ...
    def __init__(self, defaults: Optional[Dict] = None) -> None:
        ...
        logger.info("ExperimentalFlags initialized (%d defaults)", len(self._store))
    ...
    def set(self, key: str, value: Any) -> None:
        ...
        for listener in self._listeners.get(key, []):
            try:
                ...
                logger.warning("ExperimentalFlags listener error: %s", e)
