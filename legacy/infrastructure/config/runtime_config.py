...
"""InfraRuntimeConfig — Runtime-adjustable configuration."""
...
class InfraRuntimeConfig:
    ...
    def __init__(self, defaults: Optional[Dict] = None) -> None:
        ...
        logger.info("InfraRuntimeConfig initialized (%d defaults)", len(self._store))
    ...
    def set(self, key: str, value: Any) -> None:
        ...
        for listener in self._listeners.get(key, []):
            try:
                ...
                logger.warning("InfraRuntimeConfig listener error: %s", e)
