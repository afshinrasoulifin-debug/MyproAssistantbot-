...
"""InfraRequestInterceptor — Intercept and transform requests."""
...
class InfraRequestInterceptor:
    ...
    def __init__(self) -> None:
        ...
        logger.info("InfraRequestInterceptor initialized")
    ...
    async def intercept(self, data: Dict) -> Dict:
        ...
        for rule in self._rules:
            try:
                ...
                logger.warning("InfraRequestInterceptor rule '%s' error: %s", rule["name"], e)
