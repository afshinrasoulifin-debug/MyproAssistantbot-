...
"""InfraResponseInterceptor — Intercept and transform responses."""
...
class InfraResponseInterceptor:
    """InfraResponseInterceptor — Intercept and transform responses."""
    ...
    def __init__(self) -> None:
        ...
        logger.info("InfraResponseInterceptor initialized")
    ...
    async def intercept(self, data: Dict) -> Dict:
        ...
        for rule in self._rules:
            try:
                ...
                logger.warning("InfraResponseInterceptor rule '%s' error: %s", rule["name"], e)
