...
"""SessionSync — Synchronize user sessions."""
...
class SessionSync:
    ...
    def __init__(self, *, sync_interval: float = 5.0) -> None:
        ...
        logger.info("SessionSync initialized (interval=%.1fs)", sync_interval)
    ...
    async def sync(self) -> Dict:
        ...
        for peer_id, peer in self._peers.items():
            try:
                ...
                logger.warning("SessionSync sync to '%s' failed: %s", peer_id, e)
