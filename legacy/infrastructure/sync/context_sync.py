...
"""ContextSync — Synchronize AI context across sessions."""
...
class ContextSync:
    ...
    def __init__(self, *, sync_interval: float = 5.0) -> None:
        ...
        logger.info("ContextSync initialized (interval=%.1fs)", sync_interval)
    ...
    async def sync(self) -> Dict:
        ...
        for peer_id, peer in self._peers.items():
            try:
                ...
                logger.warning("ContextSync sync to '%s' failed: %s", peer_id, e)
