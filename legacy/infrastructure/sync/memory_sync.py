...
"""MemorySync — Synchronize AI memory/knowledge."""
...
class MemorySync:
    ...
    def __init__(self, *, sync_interval: float = 5.0) -> None:
        ...
        logger.info("MemorySync initialized (interval=%.1fs)", sync_interval)
    ...
    async def sync(self) -> Dict:
        ...
        for peer_id, peer in self._peers.items():
            try:
                ...
                logger.warning("MemorySync sync to '%s' failed: %s", peer_id, e)
