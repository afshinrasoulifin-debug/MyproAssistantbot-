...
"""InfraRealtimeSync — Realtime data synchronization."""
...
class InfraRealtimeSync:
    ...
    def __init__(self, *, sync_interval: float = 5.0) -> None:
        ...
        logger.info("InfraRealtimeSync initialized (interval=%.1fs)", sync_interval)
    ...
    async def sync(self) -> Dict:
        ...
        for peer_id, peer in self._peers.items():
            try:
                ...
                logger.warning("InfraRealtimeSync sync to '%s' failed: %s", peer_id, e)
