...
"""SmartClient — Auto-selecting client based on request analysis."""
...
class SmartClient:
    ...
    def __init__(self, *, base_url: str = "", timeout: float = 30.0) -> None:
        ...
        logger.info("SmartClient initialized (timeout=%.1fs)", timeout)
    ...
    async def request(self, method: str, path: str, *, body: Optional[Dict] = None,
        ...
        try:
            ...
            logger.error("SmartClient request error: %s", e)
    ...
    async def close(self) -> None:
        ...
        if self._session:
            self._session = None
        logger.debug("SmartClient closed")
