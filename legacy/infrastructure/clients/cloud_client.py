...
"""CloudClient — Multi-cloud AI client."""
...
class CloudClient:
    ...
    def __init__(self, *, base_url: str = "", timeout: float = 30.0) -> None:
        ...
        logger.info("CloudClient initialized (timeout=%.1fs)", timeout)
    ...
    async def request(self, method: str, path: str, *, body: Optional[Dict] = None,
        ...
        try:
            ...
            logger.error("CloudClient request error: %s", e)
    ...
    async def close(self) -> None:
        ...
        if self._session:
            self._session = None
        logger.debug("CloudClient closed")
