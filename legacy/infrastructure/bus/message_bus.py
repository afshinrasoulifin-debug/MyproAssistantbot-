...
"""InfraMessageBus — Typed message bus."""
...
class InfraMessageBus:
    ...
    def __init__(self) -> None:
        ...
        logger.info("InfraMessageBus initialized")
    ...
    async def publish(self, event_type: str, data: Any = None) -> int:
        ...
        for handler in handlers:
            try:
                ...
                logger.warning("InfraMessageBus handler error for '%s': %s", event_type, e)
