...
"""RemoteAgent — Agent that can be called remotely."""
...
class RemoteAgent:
    ...
    def __init__(self, name: str = "remote_agent", *, max_steps: int = 10) -> None:
        self.name = name
        self.max_steps = max_steps
        self._tools: Dict[str, Any] = {}
        self._history: List[Dict] = []
        self._state = "idle"
        logger.info("RemoteAgent '%s' initialized (max_steps=%d)", name, max_steps)
