...
"""OrchestrationAgent — Agent that orchestrates other agents."""
...
class OrchestrationAgent:
    ...
    def __init__(self, name: str = "orchestration_agent", *, max_steps: int = 10) -> None:
        self.name = name
        self.max_steps = max_steps
        self._tools: Dict[str, Any] = {}
        self._history: List[Dict] = []
        self._state = "idle"
        logger.info("OrchestrationAgent '%s' initialized (max_steps=%d)", name, max_steps)
