...
"""InfraWorkflowAgent — Agent that executes workflows."""
...
class InfraWorkflowAgent:
    """InfraWorkflowAgent — Agent that executes workflows."""

    def __init__(self, name: str = "workflow_agent", *, max_steps: int = 10) -> None:
        self.name = name
        self.max_steps = max_steps
        self._tools: Dict[str, Any] = {}
        self._history: List[Dict] = []
        self._state = "idle"
        logger.info("InfraWorkflowAgent '%s' initialized (max_steps=%d)", name, max_steps)
