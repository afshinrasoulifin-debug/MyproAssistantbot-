...
"""InfraRuntimeAgentV2 — Agent with runtime lifecycle."""
...
class InfraRuntimeAgentV2:
    """InfraRuntimeAgentV2 — Agent with runtime lifecycle."""

    def __init__(self, name: str = "runtime_agent", *, max_steps: int = 10) -> None:
        self.name = name
        self.max_steps = max_steps
        self._tools: Dict[str, Any] = {}
        self._history: List[Dict] = []
        self._state = "idle"
        logger.info("InfraRuntimeAgentV2 '%s' initialized (max_steps=%d)", name, max_steps)
