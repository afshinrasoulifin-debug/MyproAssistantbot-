...
"""WorkerNode — Dedicated worker node."""
...
class WorkerNode:
    ...
    def __init__(self, node_id: str = "worker_node", *, capacity: int = 100) -> None:
        ...
        logger.info("WorkerNode '%s' initialized (cap=%d)", node_id, capacity)
